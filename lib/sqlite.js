...
Database.prototype = Object.create(EventEmitter.prototype, {
    constructor: { value: Database, enumerable: false, writable: true, configurable: true }
});
...
Database.prototype.execute = function(plan, input, callback) {
    var db = this;
    var i = 0;
    process.nextTick(function() { run(plan[i], input); });
    ...
    function next(err, result) {
        ...
        // Cut the stack.
        process.nextTick(function() { run(plan[++i], result); });
    }
